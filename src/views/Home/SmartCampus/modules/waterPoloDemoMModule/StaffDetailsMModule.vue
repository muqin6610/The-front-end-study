        ...
        <el-table-column prop="img" label="照片" align='center'>
          <template slot-scope='scope'>
            <el-popover
             ...
             <img style='cursor:pointer;border-radius:20px;' slot="reference" v-lazy="scope.row.img" width="30" height="30"/>
            </el-popover>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip prop="number" label="工号" align='center'></el-table-column>
        <el-table-column prop="class" label="部门" align='center'></el-table-column>
